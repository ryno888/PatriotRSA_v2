...
//-------------------------------------------------------------
/**
 * CATEGORY_PROPERT_KEYWORD
 * 
 */
if(!defined("CATEGORY_PROPERT_KEYWORD")) define("CATEGORY_PROPERT_KEYWORD", "gs1.category:keyword");
/**
 * CATEGORY_PROPERT_LEAD_TIME
 * 
 */
if(!defined("CATEGORY_PROPERT_LEAD_TIME")) define("CATEGORY_PROPERT_LEAD_TIME", "gs1.category:lead_time");
/**
 * CATEGORY_PROPERT_SEO_CODE
 * 
 */
if(!defined("CATEGORY_PROPERT_SEO_CODE")) define("CATEGORY_PROPERT_SEO_CODE", "gs1.category:seo_code");
//-------------------------------------------------------------
//ERROR
//-------------------------------------------------------------
/**
